...
if __name__ == "__main__":
    ...
    modifications = [
        ('S2', 'sc_a', 'overspeed,h1_I', 'S3'),  # 在第一个机器(索引0)上添加转移
        ('S3', 'sc_d', 'fast,h1_F', 'S2'),
        ('S3', 'eb', 'stop,h1_F', 'S0'),
        ('S2', 'A_dz', 'h2_I', 'S4'),
        ('S4', 'sc_d', 'h2_F,low', 'S1'),
        ('S1', 'A_dz', 'h2_I', 'S5'),
    ...
    for _ in range(100):
        # 记录开始时间
        generator = IncrementalTestGenerator(events, fsmA, strength=2, max_tuples=10)
        generator.clear_cache()
        test_suite_v1 = generator.generate_test_suite()
        start_time = time.perf_counter()

        # 生成测试套件
        test_suite = generator.generate_test_suite(modifications)
    ...
    # # 首次生成测试套件
    # test_suite_v1 = generator.generate_test_suite()
    # print("Initial Test Suite:", test_suite_v1)
    #
    ...
    #
    # # 增量生成新测试套件
    # test_suite_v2 = generator.generate_test_suite(modifications)
    # print("Updated Test Suite:", test_suite_v2)
    # end_time = time.time()
    # print("Time taken for incremental update:", end_time - start_time)
    #
    # start_time= time.time()
    # generator2= TestGenerator(events, fsmB, strength=2, max_tuples=10)
    # test_suite_v3= generator2.generate_test_suite()
    # print("Test Suite for FSM B:", test_suite_v3)
    # end_time = time.time()
    # print("Time taken for FSM B generation:", end_time - start_time)